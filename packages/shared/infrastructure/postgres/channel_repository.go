...
func (r *ChannelRepository) ListByIDs(ctx context.Context, ids []string) ([]domain.NotificationChannel, error) {
...
func (r *ChannelRepository) ListByOrg(ctx context.Context, orgID string) ([]domain.NotificationChannel, error) {
	rows, err := r.pool.Query(ctx, `
		SELECT
			id::text,
			organization_id::text,
...
func (r *ChannelRepository) CreateChannel(ctx context.Context, ch *domain.NotificationChannel) error {
...
func (r *ChannelRepository) GetChannel(ctx context.Context, id string) (domain.NotificationChannel, error) {
	...
	if err != nil {
		...
		return domain.NotificationChannel{}, fmt.Errorf("get channel: %w", err)
	}
